...
#
# Generated by export_simulation on Tue Jun 25 14:15:20 -0300 2024
#
################################################################################
...
'-reset_run' switch to the './StateSolverMultiplier.sh' script.

./StateSolverMultiplier.sh -reset_run
...
./StateSolverMultiplier.sh -noclean_files

For more information on the script, please type './StateSolverMultiplier.sh -help'.
