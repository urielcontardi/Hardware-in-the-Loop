...
connect_bd_net [get_bd_pins hil_regs_0/pwm_cap_start_o]  [get_bd_pins hil_axi_top_0/pwm_cap_start_i]
connect_bd_net [get_bd_pins hil_regs_0/pwm_cap_stop_o]   [get_bd_pins hil_axi_top_0/pwm_cap_stop_i]
connect_bd_net [get_bd_pins hil_regs_0/pwm_cap_clear_o]  [get_bd_pins hil_axi_top_0/pwm_cap_clear_i]
connect_bd_net [get_bd_pins hil_regs_0/pwm_cap_pop_o]    [get_bd_pins hil_axi_top_0/pwm_cap_pop_i]
connect_bd_net [get_bd_pins hil_regs_0/pwm_cap_window_o] [get_bd_pins hil_axi_top_0/pwm_cap_window_i]
connect_bd_net [get_bd_pins hil_axi_top_0/pwm_cap_status_o] [get_bd_pins hil_regs_0/pwm_cap_status_i]
connect_bd_net [get_bd_pins hil_axi_top_0/pwm_cap_data_o]   [get_bd_pins hil_regs_0/pwm_cap_data_i]
connect_bd_net [get_bd_pins hil_axi_top_0/hil_time_o]    [get_bd_pins hil_regs_0/hil_time_i]
connect_bd_net [get_bd_pins hil_axi_top_0/hil_epoch_o]   [get_bd_pins hil_regs_0/hil_epoch_i]
