...
#
# Script generated by Vivado on Mon Jan 05 21:28:12 -03 2026
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : BilinearSolverUnit_DSP.sh
...
#
# Usage        : BilinearSolverUnit_DSP.sh
#                BilinearSolverUnit_DSP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BilinearSolverUnit_DSP.sh [-reset_run]
#                BilinearSolverUnit_DSP.sh [-reset_log]
#                BilinearSolverUnit_DSP.sh [-help]
#
...
#                script (type 'BilinearSolverUnit_DSP.sh -help' for more information).
#
...
# script info
echo -e "BilinearSolverUnit_DSP.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BilinearSolverUnit_DSP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.BilinearSolverUnit_DSP -o BilinearSolverUnit_DSP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./BilinearSolverUnit_DSP_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/urielcontardi/Desktop/Hardware-in-the-Loop/syn/HIL.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key BilinearSolverUnit_DSP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc BilinearSolverUnit_DSP_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BilinearSolverUnit_DSP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BilinearSolverUnit_DSP.sh [-help]\n\
Usage: BilinearSolverUnit_DSP.sh [-step]\n\
Usage: BilinearSolverUnit_DSP.sh [-lib_map_path]\n\
Usage: BilinearSolverUnit_DSP.sh [-reset_run]\n\
Usage: BilinearSolverUnit_DSP.sh [-reset_log]\n\
Usage: BilinearSolverUnit_DSP.sh [-keep_index]\n\
Usage: BilinearSolverUnit_DSP.sh [-noclean_files]\n\n\
