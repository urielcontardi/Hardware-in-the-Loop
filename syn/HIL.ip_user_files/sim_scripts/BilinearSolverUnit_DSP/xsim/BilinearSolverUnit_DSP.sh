...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_utils_v3_0_13 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L xil_defaultlib -L secureip -L xpm --snapshot BilinearSolverUnit_DSP xil_defaultlib.BilinearSolverUnit_DSP -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BilinearSolverUnit_DSP -key {Behavioral:sim_1:Functional:BilinearSolverUnit_DSP} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BilinearSolverUnit_DSP.wdb xsim.dir libdpi.so)
