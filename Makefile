...
help:
	...
	@echo "║    make cocotb-setup-nvc  Install NVC                  ║"
	@echo "║    make cocotb-report    Generate the reference report  ║"
	@echo "║                                                         ║"
	...
	@echo "║    make ps-build-test   Build ARM FPGA smoke test       ║"
	@echo "║    make ps-deploy IP=x  Build + SCP to board            ║"
	@echo "║    make ps-deploy-test IP=x  Deploy FPGA smoke test     ║"
